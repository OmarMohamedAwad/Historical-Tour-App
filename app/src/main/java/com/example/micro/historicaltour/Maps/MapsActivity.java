package com.example.micro.historicaltour.Maps;
        ...
        GoogleMap.OnMarkerDragListener
{
    ...
    public void Search(View v)
    {
        ...
        switch(v.getId()) {
            ...
            case R.id.b_to:
                ...
                dataTransfer[0] = mMap;
                dataTransfer[1] = url;
                dataTransfer[2] = new LatLng(30.0478, 31.2336);
                getDirectionsData.execute(dataTransfer);
                mMap.clear();
                LatLng PERTH = new LatLng(30.0478, 31.2336);
    ...
    private String getDirectionsUrl()
    {
        ...
        googleDirectionsUrl.append("&destination="+30.0478+","+31.2336);
        googleDirectionsUrl.append("&key="+"AIzaSyAPxiDJeX04SB_lUt-7fxVxd4slMXp0n4Y");
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace)
    {
        ...
        googlePlacesUrl.append("&key="+"AIzaSyDgJXtllE4IHXB99POaB-tj3jaeGl864_A");
